        ...
        >
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.statusCard, isDarkMode && styles.cardDark]}>
                    ...
                    {pushToken && (
                        <View style={styles.tokenContainer}>
                            ...
                            <Text style={[styles.tokenText, isDarkMode && styles.textDark]} numberOfLines={1}>
                                {pushToken.token}
                            </Text>
                        </View>
                    )}
                    ...
                    <View style={styles.badgeContainer}>
                        <Text style={[styles.badgeLabel, isDarkMode && styles.textDark]}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity onPress={handleSchedule5Seconds} style={[styles.button, styles.buttonInfo]}>
                        <Ionicons name="time-outline" size={20} color="#fff" />
                        <Text style={styles.buttonText}>Programmer (5 secondes)</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={handleSchedule30Seconds} style={[styles.button, styles.buttonInfo]}>
                        <Ionicons name="calendar-outline" size={20} color="#fff" />
                        <Text style={styles.buttonText}>Programmer (30 secondes)</Text>
                    </TouchableOpacity>

                    <View style={styles.buttonRow}>
                        <TouchableOpacity onPress={handleSetBadge} style={[styles.button, styles.buttonSmall, styles.buttonWarning]}>
                            <Ionicons name="ellipse" size={16} color="#fff" />
                            <Text style={styles.buttonTextSmall}>Badge: 5</Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={handleClearBadge} style={[styles.button, styles.buttonSmall, styles.buttonDanger]}>
                ...
                <View style={styles.section}>
                    ...
                    {testResults.length === 0 ? (
                        <View style={[styles.emptyResults, isDarkMode && styles.cardDark]}>
                        ...
                        <View style={[styles.resultsContainer, isDarkMode && styles.cardDark]}>
...
const styles = StyleSheet.create({
    ...
    tokenContainer: { marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#e5e7eb' },
    tokenLabel: { fontSize: 12, color: '#6b7280', marginBottom: 4 },
    tokenText: { fontSize: 11, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace' },

    badgeContainer: { marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#e5e7eb' },
    badgeLabel: { fontSize: 14, fontWeight: '500' },

    scheduledContainer: { marginTop: 8 },
    scheduledLabel: { fontSize: 14, color: '#6b7280' },
    ...
    resultText: { fontSize: 12, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace' },
